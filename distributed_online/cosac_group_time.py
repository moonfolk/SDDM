import numpy as np
from geom_tm_puncture import GeomTm
...
class CosacParallel(BaseEstimator, ClusterMixin):
    ...
    def save_cosac(self, year, group):
    ...
    def process_group(self, time_group_path):
        ...
        #############
        t_s = time.time()
        self.cosac = GeomTm(toy=False, verbose=False, delta=self.delta, prop_n=self.prop_n,
